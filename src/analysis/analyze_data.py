...
# --- Load JSON files ---
crime_df = pd.read_json('src/analysis/incident_reports.json')
pings_df = pd.read_json('src/analysis/phone_pings.json')
suspects_df = pd.read_json('src/analysis/suspects.json')
